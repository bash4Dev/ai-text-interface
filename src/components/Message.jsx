...
const Message = ({ message, onSummarize, onTranslate, onTranslationLanguageChange }) => {
  return (
    <div className="message">
      ...
      <div className="message-meta">
        {message.isLoadingDetection ? (
          ...
          <span>
            Detected Lang: {langMap[message.detectedLanguage] || message.detectedLanguage}
          </span>
        ) : null}
      </div>
      ...
      <div className="message-actions">
        ...
        <div className="translation-group">
          <select
            ...
            onChange={(e) => onTranslationLanguageChange(message.id, e.target.value)}
