...
const App = () => {
        ...
        detector = await window.ai.languageDetector.create({
          monitor: (m) => {
            m.addEventListener('downloadprogress', (e) => {
              // Here we assume the event has loaded and total properties
              console.log(
                `Language model: Downloaded ${e.loaded} of ${e.total} bytes.`
              );
            });
          },
        });
  ...
  const handleTranslationLanguageChange = (id, lang) => {
    setMessages((prev) =>
